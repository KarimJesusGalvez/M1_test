...
import Static_classes.ManageDB;
import Static_classes.Search_registry;
import Static_classes.Test;
...
public class Menu {
    ...
    List<Bibliographic_entry> registries = new ArrayList<Bibliographic_entry>();
    ...
    public boolean[] startup(){
        ...
        for (int count = 0; count < 3; count++) {
            ...
            General_imp menuprint = new General_imp();
            menuprint.print();
            ...
            if (selection.equals("7")
                ...
                System.out.println("Closing Database.Menu");
                System.out.println("...");
                System.out.println("......");
    ...
    /**
     * Passes the menu Database registries to the actual database
     ...
     * @param option should be a String number corresponding to the option in startup()
     *
